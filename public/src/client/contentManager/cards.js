                ...
                <div data-contentid="${data._id}">
                    <div class="ml-0" style="width:100%;">
                        <div class="">
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        ${data.approvalCount ? `<span class="badge rounded-pill" style="border-radius:6px; background-color:rgb(107 255 107 / 50%); color:green; padding:5px 10px;">
                                        ${data.approvalCount} ${data.approvalCount == 1 ? 'approval' : 'approvals'}</span>` : ''}
                                        </div>
                                    </div>
                            ...
                            <div class="mt-1 sdlms-text-white-14px text-dark text-ellipse-4" style="min-height: 70px;">
                                ${data.content}
                            </div>
