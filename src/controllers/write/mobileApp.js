...
App.deleteMascot = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.deleteMascot(req));
};
...
/**
 * @description CRUD methods for a Reflectionn templates
 * @author Arbaaz
 * @date 11 June 22
 */
App.createReflectionTemplate = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.createReflectionTemplate(req));
};
App.getReflectionTemplates = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.getReflectionTemplates(req));
};
App.updateReflectionTemplate = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.updateReflectionTemplate(req));
};
App.deleteReflectionTemplate = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.deleteReflectionTemplate(req));
};
...
App.getReflection = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.getReflection(req));
};
...
App.getComments = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.getComments(req));
}

App.createComment = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.createComment(req));
}

App.updateComment = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.updateComment(req));
}

App.deleteComment = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.deleteComment(req));
}

App.postGlobalNotifications = async (req,res) => {
	helpers.formatApiResponse(200, res, await api.appApi.postGlobalNotifications(req));
}

App.getGlobalNotifications = async (req,res) => {
	helpers.formatApiResponse(200, res, await api.appApi.getGlobalNotifications(req));
}

App.deleteGlobalNotifications = async (req,res) => {
	helpers.formatApiResponse(200, res, await api.appApi.deleteGlobalNotifications(req));
}

App.getMyDiscussions = async (req,res) => {
	helpers.formatApiResponse(200, res, await api.appApi.getMyDiscussions(req));
}

App.getFeeds = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.getFeeds(req));
}

App.getDrafts = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.getDrafts(req));
}

App.getMess = async (req,res) => {
	helpers.formatApiResponse(200,res,await api.appApi.getMyMess(req));
}
