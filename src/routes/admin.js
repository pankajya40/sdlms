...
module.exports = function (app, middleware, controllers) {
	...
	helpers.setupAdminPageRoute(app, '/admin/manage/anecdotes/saved', middleware, middlewares, controllers.admin.anecdotes.getSaved);
	helpers.setupAdminPageRoute(app, '/admin/manage/anecdotes/add', middleware, middlewares, controllers.admin.anecdotes.getAdd);
	...
	helpers.setupAdminPageRoute(app, '/admin/manage/notifications', middleware, middlewares, controllers.admin.notifications.get);
	helpers.setupAdminPageRoute(app, '/admin/manage/notifications/create', middleware, middlewares, controllers.admin.notifications.getCreate);
