...
var GlobalPageRoutes = require('./GlobalPageRoutes');
...
var PDGMSRoutes = require('./PDGMSPageRoutes');
var mobilePageRoutes = require('./mobilePageRoutes');
var resumeProfilePageRoutes = require('./resumeProfilePageRoutes');
var DTFormsRoutes = require('./DTFormPageRoutes');
var cccmsPageRoutes = require('./cccmsPageRoutes');
var contentRoutes = require('./contentRoutes');
var observationPanelRoutes = require('./observationPanel');
const dataportal = require('./dataportal');
var observationPanelRoutes = require('./observationPanel');
var generatorPageRoutes = require('./generatorPageRoutes');
var rigorBuilderPageRoutes = require('./rigorBuilderPageRoutes');
var socialQuizRoutes = require('./socialQuizRoutes');
var applicationManager = require('./applicationManagerRoutes')
var tocPageRoutes = require('./tocPageRoutes');
...
function addCoreRoutes(app, router, middleware) {
	...
	GlobalPageRoutes(router, middleware, controllers);
	...
	PDGMSRoutes(router, middleware, controllers);
	mobilePageRoutes(router, middleware, controllers);
	resumeProfilePageRoutes(router, middleware, controllers);
	DTFormsRoutes(router, middleware, controllers);
	cccmsPageRoutes(router, middleware, controllers);
	contentRoutes(router, middleware, controllers);
	observationPanelRoutes(router, middleware, controllers);
	dataportal(router, middleware, controllers);
	generatorPageRoutes(router, middleware, controllers);
	rigorBuilderPageRoutes(router, middleware, controllers);
	socialQuizRoutes(router, middleware, controllers);
	applicationManager(router, middleware, controllers);
	tocPageRoutes(router, middleware, controllers);
	...
	app.use(relativePath + '/assets/uploads/files', middleware.requests.logAppDownloads, express.static(path.resolve(__dirname, '../../public/uploads/others'), staticOptions));
