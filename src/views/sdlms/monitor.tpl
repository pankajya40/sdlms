                    ...
                    <div class="sdlms-section-body custom-padding-x-40" collapse-body>
                        <div class="d-flex" upcoming-session>
                            <div class="sdlms-calendar d-flex align-items-center justify-content-center position-relative">
                                 <!-- IF isTeacher -->
                                   <img src="/assets/images/clock.png" style="width:120px" alt="" />
                                 <!-- ELSE -->
                            ...
                            <div class="d-flex flex-column w-100 justify-content-between">
                                ...
                                <div class="d-flex pl-0 pl-sm-4 justify-content-between align-items-end align-items-sm-start">
                                    <div class="w-100">
                                       ...
                                       <form id="createInstantSession">
                                        <div class="form-group">
                                          <input type="text" required name="topic" class="form-control" placeholder="Topic">
                                        </div>
                                        <div class="form-group">
                                           <input class="form-control" name="teaser" placeholder="Teaser (Optional)" >
                                         </div>
                                          
                                         
                                        <div class="d-flex justify-content-end">
                                            <button type="submit" class="sdlms-button button-primary px-3-2 py-1-2 sdlms-text-white-16px d-flex align-items-center justify-content-center font-weight-500 sdlms-join-class-button">Start Session</button>
                                        </div>
                                        </form>
                                        <!-- ELSE -->
                                        <button
