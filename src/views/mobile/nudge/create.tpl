      ...
      <form id="nudgeCreate" class="needs-validation font-12" novalidate>
        ...
        <div class="form-group">
          <input
            ...
            id="assetId"
          />
          <div class="bg-white rounded-bottom border-bottom d-none" id="event-listing-container"></div>
          <div class="bg-white rounded-bottom border-bottom d-none" id="article-listing-container"></div>
        </div>
        <div class="form-group">
        ...
        <div class="row">
          ...
          <div class="col-6">
            <div class="form-group">
              <label for="schedule">Select Start Time</label>
              <input
                type="datetime-local"
                class="form-control font-12 secondary-border font-12 rounded-10-px"
                id="schedule"
        ...
        <div class="d-flex justify-content-between py-3">
          <div></div>
          <button type="submit" class="button-brand rounded-lg btn btn-sm shadow-sm px-4 asset-create-btn">
            Publish
          </button>
        </div>
      </form>
