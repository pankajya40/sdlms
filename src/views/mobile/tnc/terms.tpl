<div class="fixed-top py-2 font-14 d-flex justify-content-between align-items-center container bg-white shadow-sm">
    <i class="fa-solid fa-arrow-left"></i>
    <p class="mb-0">Terms of Use</p>
    <p class="mb-0"></p>
</div>

<div class="container font-12 text-center pt-5 pb-3">
    <div class="mb-5 pt-3">
        <p class="font-bold">OVERVIEW</p>
        <p class="mb-2">
            This website is operated by <span class="font-medium">DeepThought EduTech Ventures Private
                Limited.</span>
            Throughout the site, the terms
            “we”, “us” and
            “our” refer to <span class="font-medium">DeepThought EduTech Ventures Private Limited.</span>
            DeepThought
            EduTech Ventures Private Limited
            offers this
        ...
        <p class="mb-2">
            ...
            bound
            by the
            following terms and conditions (“Terms of Service”, “Terms”), including those additional terms and
            conditions and
            policies referenced herein and/or available by hyperlink. These Terms of Service apply to all users of
            the
            site,
        ...
        <p class="mb-2">
            ...
            conditions of this
            agreement, then you may not access the website or use any services. If these Terms of Service are
            considered
            an offer,
        ...
        <p class="mb-2">
            ...
            Service. You can
            review the most current version of the Terms of Service at any time on this page. We reserve the right
            to
            update, change
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 1 - ONLINE STORE TERMS</p>
        <p class="mb-2">
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 2 - GENERAL CONDITIONS</p>
        <p class="mb-2">
        ...
        <p class="mb-2">
            ...
            the Service, or
            access to the Service or any contact on the website through which the service is provided, without
            express written
            permission by us.
        </p>
        <p class="mb-2">
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</p>
        <p class="mb-2">
            We are not responsible if information made available on this site is not accurate, complete or current.
            The material on
            this site is provided for general information only and should not be relied upon or used as the sole
            basis for making
            decisions without consulting primary, more accurate, more complete or more timely sources of
            information. Any reliance
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</p>
        <p class="mb-2">
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 5 - PRODUCTS OR SERVICES</p>
        <p class="mb-2">
        ...
        <p class="mb-2">
            ...
            of any products or services that we offer. All descriptions of products or product pricing are subject
            to change at
            anytime without notice, at the sole discretion of us. We reserve the right to discontinue any product at
            any time. Any
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</p>
        <p class="mb-2">
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 7 - OPTIONAL TOOLS</p>
        <p class="mb-2">
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 8 - THIRD-PARTY LINKS</p>
        <p class="mb-2">
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</p>
        <p class="mb-2">
        ...
        <p class="mb-2">
            ...
            contain libelous or
            otherwise unlawful, abusive or obscene material, or contain any computer virus or other malware that
            could in any way
            affect the operation of the Service or any related website. You may not use a false e-mail address,
            pretend to be
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 10 - PERSONAL INFORMATION</p>
        <p class="mb-2">
            Your submission of personal information through the store is governed by our Privacy Policy.
        </p>
    </div>
    <div class="mb-5">
        <p class="font-bold">SECTION 12 - PROHIBITED USES</p>
        <p class="mb-2">
            ...
            (d) to infringe
            upon or violate our intellectual property rights or the intellectual property rights of others; (e) to
            harass, abuse,
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</p>
        <p class="mb-2">
        ...
        <p class="mb-2">
            ...
            provided 'as is' and
            'as available' for your use, without any representation, warranties or conditions of any kind, either
            express or
        ...
        <p class="mb-2">
            In no case shall <span class="font-medium">DeepThought EduTech Ventures Private Limited</span>, our
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 14 - INDEMNIFICATION</p>
        <p class="mb-2">
            You agree to indemnify, defend and hold harmless <span class="font-medium">DeepThought EduTech Ventures
                Private Limited</span> and our parent,
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 15 - SEVERABILITY</p>
        <p class="mb-2">
            ...
            unenforceable
            portion shall be deemed to be severed from these Terms of Service, such determination shall not affect
            the validity and
            enforceability of any other remaining provisions.
        </p>
    </div>
    <div class="mb-5">
        <p class="font-bold">SECTION 16 - TERMINATION</p>
        <p class="mb-2">
        ...
        <p class="mb-2">
            ...
            these Terms of
            Service at any time by notifying us that you no longer wish to use our Services, or when you cease using
            our site.
        </p>
        <p class="mb-2">
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 17 - ENTIRE AGREEMENT</p>
        <p class="mb-2">
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 18 - GOVERNING LAW</p>
        <p class="mb-2">
            These Terms of Service and any separate agreements whereby we provide you Services shall be governed by
            and construed in
            accordance with the laws of India and jurisdiction of Hyderabad, Telangana, India
        </p>
    </div>
    <div class="mb-5">
        <p class="font-bold">SECTION 19 - CHANGES TO TERMS OF SERVICE</p>
        <p class="mb-2">
    ...
    <div class="mb-5">
        <p class="font-bold">SECTION 20 - CONTACT INFORMATION</p>
        <p class="mb-2">
            Questions about the Terms of Service should be sent to us at cs@deepthought.education
        </p>
    </div>
</div>
