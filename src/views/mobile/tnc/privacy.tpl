<div class="fixed-top py-2 font-14 d-flex justify-content-between align-items-center container bg-white shadow-sm">
    ...
    <div class="container font-12 text-center pt-5 pb-3">
        ...
        <section class="mb-5 pt-3">
            <p class="font-bold">SECTION 1 - WHAT DO WE DO WITH YOUR INFORMATION?</p>
            <p class="mb-2">
        ...
        <section class="mb-5 pt-3">
            <p class="font-bold">SECTION 2 - CONSENT</p>
            <p class="mb-2">
            ...
            <p class="mb-2">
                ...
                an order,
                arrange for a delivery or return a purchase, we imply that you consent to our collecting it and using it
                for that
            ...
            <p class="mb-2">
                ...
                privacy@deepthought.education
            </p>
        </section>

        <section class="mb-5 pt-3">
            <p class="font-bold">SECTION 3 - DISCLOSURE</p>
            <p class="mb-2">
        ...
        <section class="mb-5 pt-3">
            <p class="font-bold">SECTION 4 - PAYMENT</p>
            <p class="mb-2">
                We use Razorpay for processing payments. We/Razorpay do not store your card data on their servers. The
                data is encrypted
                through the Payment Card Industry Data Security Standard (PCI-DSS) when processing payment. Your
                purchase transaction
                data is only used as long as is necessary to complete your purchase transaction. After that is complete,
                your purchase
            ...
            <p class="mb-2">
                ...
                Council, which is a
                joint effort of brands like Visa, MasterCard, American Express and Discover. PCI-DSS requirements help
                ensure the secure
                handling of credit card information by our store and its service providers. For more insight, you may
                also want to read
                terms and conditions of razorpay on https://razorpay.com
            </p>
        </section>

        <section class="mb-5 pt-3">
            <p class="font-bold">SECTION 5 - THIRD-PARTY SERVICES</p>
            <p class="mb-2">
            ...
            <p class="mb-2">
                <span class="font-medium">Links:</span> When you click on links on our store, they may direct you away
                from our site. We are not responsible for the
                privacy practices of other sites and encourage you to read their privacy statements.
            </p>
        </section>

        <section class="mb-5 pt-3">
            <p class="font-bold">SECTION 6 - SECURITY</p>
            <p class="mb-2">
        ...
        <section class="mb-5 pt-3">
            <p class="font-bold">SECTION 7 - COOKIES</p>
            <p class="mb-2">
        ...
        <section class="mb-5 pt-3">
            <p class="font-bold">SECTION 8 - AGE OF CONSENT</p>
            <p class="mb-2">
                By using this site, you represent that you are at least the age of majority in your state or province of
                residence, or
                that you are the age of majority in your state or province of residence and you have given us your
        ...
        <section class="mb-5 pt-3">
            <p class="font-bold">SECTION 9 - CHANGES TO THIS PRIVACY POLICY</p>
            <p class="mb-2">
                We reserve the right to modify this privacy policy at any time, so please review it frequently. Changes
                and
                clarifications will take effect immediately upon their posting on the website. If we make material
                changes to this
        ...
        <section class="mb-5 pt-3">
            <p class="font-bold">QUESTIONS AND CONTACT INFORMATION</p>
            <p class="mb-2">
                If you would like to: access, correct, amend or delete any personal information we have about you,
                register a complaint,
                or simply want more information contact our Privacy Compliance Officer at <span
                    class="font-medium">privacy@deepthought.education</span>
            </p>
        </section>
