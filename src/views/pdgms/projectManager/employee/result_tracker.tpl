...
<div>
    <div class="container-fluid">
       <div class="row mt-2 px-0">
            <div class="col-10">
                <h3 class="sdlms-text-black font-weight-700">Result Tracker</h3>
        ...
        <div class="row mt-2 justify-content-between bg-light pt-2 px-2 mx-3">
            <div class=" text-center sdlms-text-black font-weight-500"><h3>Rate Your Task</h3></div>
        ...
        <div class="row">
            <div class="col-8 pr-2">
               <div class="text-start sdlms-text-black font-weight-500"><h3>Social Scorecard</h3></div> 
               <ul class="list-group pr-5" >
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    Morbi leo risus
                    <span class="badge badge-danger badge-pill">aborted</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    Cras justo odio
                    <span class="badge badge-primary badge-pill">done</span>
            ...
            <div class="col-4 border-left border-dark">
                <div class=" text-center sdlms-text-black font-weight-500"><h3>Productivity Growth</h3></div> 
                <div class="text-right"> <select class="months" name="months" id="months">
                    <option value="all">None</option>
                    <option value="resent">Resent</option>
                    <option value="deadline">Deadline</option>
                    <option value="priority">Priority</option>
        ...
        <div class=" text-center sdlms-text-black font-weight-500"><h3>Learning Agenda</h3></div>
